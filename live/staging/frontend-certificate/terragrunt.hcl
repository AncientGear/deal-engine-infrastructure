...
inputs = {
  domain_name               = "staging-dealengine.saul-tzakum.com"
  subject_alternative_names = ["*.staging-dealengine.saul-tzakum.com"]
  cloudflare_zone_id        = "e9de4cd1676a312ab2397d27977d00ab"
  tags = {
    Environment = include.env.locals.env
    Project     = "dealengine"
    Maintainer  = "AncientGear"
    Name        = "staging-dealengine-frontend-certificate"
  }
}
